...
setup(
    ...
    url='https://github.com/collective/plone.initializer',
    project_urls={
        'PyPI': 'https://pypi.python.org/pypi/plone.initializer',
        'Source': 'https://github.com/collective/plone.initializer',
        'Tracker': 'https://github.com/collective/plone.initializer/issues',
